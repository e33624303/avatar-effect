...
const GLTFLoader = (function () {
  ...
  GLTFTextureWebPExtension.prototype.loadTexture = function (textureIndex) {
    ...
    const source = json.images[extension.source];
    const loader = source.uri ? parser.options.manager.getHandler(source.uri) : parser.textureLoader;
  ...
  function createPrimitiveKey(primitiveDef) {
    ...
    if (dracoExtension) {
      geometryKey = `draco:${dracoExtension.bufferView}:${dracoExtension.indices}:${createAttributesKey(
  ...
  GLTFParser.prototype.createUniqueName = function (originalName) {
    let name = PropertyBinding.sanitizeNodeName(originalName || '');
